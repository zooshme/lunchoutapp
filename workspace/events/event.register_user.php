...
class eventregister_user extends SectionEvent
{
    public $ROOTELEMENT = 'register-user';
    ...
    public static function about()
    {
        return array(
            ...
            'release-date' => '2018-06-02T10:34:14+00:00',
            'trigger-condition' => 'action[register-user]'
        );
    }
    ...
    public static function documentation()
    {
        return '
                ...
                <pre class="XML"><code>&lt;register-user result="success" type="create | edit">
    &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/register-user></code></pre>
                <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned.</p>
                <pre class="XML"><code>&lt;register-user result="error">
...
...&lt;/register-user></code></pre>
    ...
    &lt;label>Role
        ...
        &lt;/select>
    &lt;/label>
    &lt;input name="action[register-user]" type="submit" value="Submit" />
&lt;/form></code></pre>
                <p>To edit an existing entry, include the entry ID value of the entry in the form. This is best as a hidden field like so:</p>
                <pre class="XML"><code>&lt;input name="id" type="hidden" value="23" /></code></pre>
                <p>To redirect to a different location upon a successful save, include the redirect location in the form. This is best as a hidden field like so, where the value is the URL to redirect to:</p>
                <pre class="XML"><code>&lt;input name="redirect" type="hidden" value="http://lunchout.local/success/" /></code></pre>
...
&lt;/form></code></pre>';
    ...
    {
        if (isset($_POST['action']['register-user'])) {
